...
dst_model = fullfile('data','exp_vot-otb_start','net-epoch-3.mat');
 mdnet_roi_pretrain('seqsList',...
     ...
     'netFile', dst_model,...
     'expDirName', 'exp_vot-otb_start',... 
      'imdbDir', fullfile('models','data_vot-otb'),...
      'imdbName', 'roi_imdb_start',...
      'modelPath', fullfile('models', 'net-deployed_vot-otb_start_epoch3.mat'), ...
      'intemidiate', true, 'hardnegmining', false, 'gpus', [2,3,4,5], 'piecewise', false...
      );
