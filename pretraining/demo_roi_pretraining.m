...
dst_model = fullfile('models', 'mdnet_roi_init_pw_sub7_bbox.mat');
mdnet_roi_prepare_model('src_model', './models/imagenet-vgg-m-conv1-3.mat',...
     'dst_model', dst_model,'subdivision', 7);
...
%     'netFile', dst_model,...
%     'expDirName', 'exp_vot-otb_start_search_region_seven_inenlarge',... 
%      'imdbDir', fullfile('models','data_vot-otb'),...
%      'imdbName', 'roi_imdb_start_region_seven_inenlarge',...
%      'modelPath', fullfile('models', 'net-deployed_vot-otb_start_search_region_seven_inenlarge.mat'), ...
...
%     struct('dataset','vot2015','list','pretraining/seqList/vot15-otb.txt')},...
%     'netFile', dst_model,...
%     'expDirName', 'exp_vot-otb_start_search_region_five_inenlarge_sub3',... 
%      'imdbDir', fullfile('models','data_vot-otb'),...
%      'imdbName', 'roi_imdb_start_region_five_inenlarge_sub3',...
%      'modelPath', fullfile('models', 'net-deployed_vot-otb_start_search_region_five_inenlarge_sub3.mat'), ...
%      'intemidiate', false, 'hardnegmining', false, 'gpus', [2,3,4,5,6,7], 'piecewise', false, 'visualize', false...
%      );
 mdnet_roi_pretrain('seqsList',...
     {struct('dataset','vot2013','list','pretraining/seqList/vot13-otb.txt'),...
     struct('dataset','vot2014','list','pretraining/seqList/vot14-otb.txt'),...
     struct('dataset','vot2015','list','pretraining/seqList/vot15-otb.txt')},...
     'netFile', dst_model,...
     'expDirName', 'exp_vot-otb_start_search_region_five_inenlarge_sub7',... 
      'imdbDir', fullfile('models','data_vot-otb'),...
      'imdbName', 'roi_imdb_start_region_five_inenlarge_sub7',...
      'modelPath', fullfile('models', 'net-deployed_vot-otb_start_search_region_five_inenlarge_sub7.mat'), ...
      'intemidiate', false, 'hardnegmining', false, 'gpus', [2,3], 'piecewise', false, 'visualize', false...
      );
