...
%dst_model = fullfile('data','exp_vot-otb_start','net-epoch-3.mat');
 mdnet_roi_pretrain('seqsList',...
     ...
     'netFile', dst_model,...
     'expDirName', 'exp_vot-otb_start_search_region_five',... 
      'imdbDir', fullfile('models','data_vot-otb'),...
      'imdbName', 'roi_imdb_start_region_twice',...
      'modelPath', fullfile('models', 'net-deployed_vot-otb_start_search_region_five.mat'), ...
