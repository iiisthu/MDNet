...
dst_model = fullfile('models', 'mdnet_roi_init_pw_sub7_fixed.mat');
...
mdnet_roi_pretrain('seqsList',...
    ...
    'netFile', 'data/exp_val005_pw_sbbox_relu_sub7_fixed_test/net-epoch-11.mat',...
    'expDirName', 'exp_val005_pw_sbbox_relu_sub7_fixed_test',... 
    'imdbDir', fullfile('models','data_otb-vot14'),...
    'modelPath', fullfile('models', 'net-deployed_shared_bbox_relu_sub7_fixed_test-epoch11.mat')...
    );
