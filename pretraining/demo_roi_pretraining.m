...
%     'netFile', dst_model,...
%     'expDirName', 'exp_val005_pw_sbbox_relu_sub7_bbox',... 
%     'imdbDir', fullfile('models','data_otb-vot14'),...
%     'modelPath', fullfile('models', 'net-deployed_shared_bbox_relu_sub7_bbox.mat')...
%     );
mdnet_roi_pretrain('seqsList',...
    {struct('dataset','otb','list','pretraining/seqList/otb-vot14.txt')},...
    'netFile', dst_model,...
    'expDirName', 'exp_nc_sub7_bbox_test',... 
    'imdbDir', fullfile('models','data_otb-vot14'),...
    'modelPath', fullfile('models', 'net-deployed_nc_sub7_bbox_epoch.mat')...
    );
% % for experiments on VOT14
% mdnet_roi_pretrain('seqsList',...
%     {struct('dataset','otb','list','pretraining/seqList/otb-vot14.txt')},...
%     'netFile', dst_model,...
%     'expDirName', 'exp_val005_pw_sbbox_relu',... 
%     'imdbDir', fullfile('models','data_otb-vot14'),...
%     'modelPath', fullfile('models', 'net-deployed_shared_bbox_relu.mat')...
%     );
