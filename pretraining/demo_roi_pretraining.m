...
%     );
dst_model = fullfile('data','exp_sub3_oneas_large','net-epoch-4.mat');
mdnet_roi_pretrain('seqsList',...
    {struct('dataset','otb','list','pretraining/seqList/otb-vot14.txt')},...
    'netFile', dst_model,...
    'expDirName', 'exp_sub3_oneas_large',... 
    'imdbDir', fullfile('models','data_otb-vot14'),...
    'modelPath', fullfile('models', 'net-deployed_sub3_oneas_large_epoch4.mat')...
    );
% % for experiments on VOT14
% mdnet_roi_pretrain('seqsList',...
%     {struct('dataset','otb','list','pretraining/seqList/otb-vot14.txt')},...
