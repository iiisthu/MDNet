...
dst_model = fullfile('models', 'mdnet_roi_init_pw_sub5.mat');
...
mdnet_roi_pretrain('seqsList',...
    ...
    'netFile', 'data/exp_val005_pw_sbbox_relu_sub5/net-epoch-10.mat',...
    'expDirName', 'exp_val005_pw_sbbox_relu_sub5',... 
    'imdbDir', fullfile('models','data_otb-vot14'),...
    'modelPath', fullfile('models', 'net-deployed_shared_bbox_relu_sub5.mat')...
    );
