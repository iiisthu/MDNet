...
%dst_model = fullfile('data','exp_vot-otb_sub3_oneas_large_nopw','net-epoch-4.mat');
mdnet_roi_pretrain('seqsList',...
    ...
    'netFile', dst_model,...
    'expDirName', 'exp_vot-otb_sub3_oneas_large_nopw',... 
     'imdbDir', fullfile('models','data_vot-otb'),...
     'modelPath', fullfile('models', 'net-deployed_vot-otb_sub3_oneas_large_nopw.mat')...
     );
